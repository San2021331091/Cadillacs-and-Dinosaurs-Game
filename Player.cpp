...
bool audioOn = false;
    ...
    if (winClose) {
        ...
        if (!texture1.loadFromFile(FileLoad::getImageFile("image1.png")) ||
            !texture2.loadFromFile(FileLoad::getImageFile("image2.png")) ||
            !texture3.loadFromFile(FileLoad::getImageFile("image3.png")) ||
            !texture4.loadFromFile(FileLoad::getImageFile("image4.png"))) {
